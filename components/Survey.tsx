...
const SURVEY_OPTIONS = [
  ...
  { id: "client-onboarding", label: "Quoting, Fact-Finding & Client Onboarding", description: "Pre-sale fact-finding, quoting, information gathering, and post-sale intake paperwork, form collection, and compliance-gated scheduling like Medicare\u2019s 48-hour Scope of Appointment rule bury salespeople in admin instead of letting them sell." },
